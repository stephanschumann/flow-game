...
- **Barrierefreiheit:** alles auch per Tastatur bedienbar; Bedeutung nie nur über Farbe; ausreichender Kontrast; ruhiger Modus mit weniger Bewegung. **Bewusste Ausnahme (FEATURE-008, 2026-07-29):** Die Kartenbewegung in den Runden 1–3 ist seit FEATURE-008 ausschließlich per Ziehen (Pointer Events, Maus/Trackpad/Touch) bedienbar – der bisherige Klick-Button wurde vollständig ersetzt, nicht ergänzt. Diese eine Interaktion ist damit nicht mehr per Tastatur bedienbar; es gibt bewusst keinen gleichwertigen Tastatur-/Screenreader-Weg dafür. Eine von Stephan bewusst getroffene, ausdrücklich auf genau diese eine Interaktion beschränkte Abweichung von der obigen Anforderung (siehe `Backlog.md`, Ticket FEATURE-008, finale Klärung Frage 6) – künftige Tickets sollten diese Ausnahme nicht übersehen und sie nicht stillschweigend auf andere Interaktionen ausweiten.
